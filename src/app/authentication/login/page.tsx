    ...
    <div className="w-full grid place-items-center bg-gradient-to-r from-sky-100 via-white to-sky-100 py-5">
      <div className="relative my-10  w-full max-w-3xl flex justify-center items-center">
        ...
        <div className="w-fit grid z-10  bg-white  rounded-xl my-10 shadow-sm gap-5 ">
          ...
          <div className="grid place-items-center px-4 lg:px-20 gap-5 pb-5">
            ...
            <div className="flex gap-10 my-4">
              <button
                className="px-10 py-1 bg-blue-300 enabled:bg-blue-500 enabled:hover:bg-blue-400 text-white rounded-md"
                onClick={onLogin}
              ...
              <button
                ...
                className="px-10 py-1 hover:bg-blue-400 hover:text-white  text-blue-500 rounded-md"
                onClick={() => {
